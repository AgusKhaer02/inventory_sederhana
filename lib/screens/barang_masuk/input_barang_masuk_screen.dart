...
class InputBarangMasukScreen extends StatefulWidget {
  const InputBarangMasukScreen({super.key});

  @override
  State<InputBarangMasukScreen> createState() => _InputBarangMasukScreenState();
}

class _InputBarangMasukScreenState extends State<InputBarangMasukScreen> {
  int quantity = 0;
  int dropdownBarang = 0;

  insertBarangMasuk() async {
    await context.read<BarangMasukCubit>().createBarang(
